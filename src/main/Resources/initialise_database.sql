...
INSERT INTO ErrorDef (ErrorCode,Description,Priority,Explanation) VALUES (1,'‘YoungPersonsID’ not of the correct length ',1,'The young person’s identifier must contain 13 the 3 digit DatabaseID followed by the local CCIS ID, and with padded 0s. eg 4440000123456');;
...
INSERT INTO ErrorDef (ErrorCode,Description,Priority,Explanation) VALUES (40,'‘DOB’ contains a value which makes the young person without a SEND flag over the age of 18',1,'18-24 year olds should only be included in the XML extract if they have a current education, health and care (EHC) plan');;
...
INSERT INTO ErrorDef (ErrorCode,Description,Priority,Explanation) VALUES (226,'‘NEETStartDate’ is populated for a young person whose current Activity is not NEET',1,'A NEET start date should only be recorded if the young person’s current activity is NEET. Please check the young person’s current activity and update it to NEET if appropriate');;
...
INSERT INTO ErrorDef (ErrorCode,Description,Priority,Explanation) VALUES (254,'Activity of ‘Special Post-16 Institutions’ without SEND Flag of ‘Y’',1,'This activity is only valid for young people with a SEND');;
...
INSERT INTO ErrorDef (ErrorCode,Description,Priority,Explanation) VALUES (262,'‘ActivityCode’ is 260, 290, 350, 616 or 710 and the ‘ReviewDate’ doesn’t contain a value',1,'All young people in temporary employment, gap year, custody or those with an agreed start date should have a current activity review date');;
...
INSERT INTO ErrorDef (ErrorCode,Description,Priority,Explanation) VALUES (303,'‘SENSupportFlag’ does not contain a value',2,'This field must be completed for every record');;
INSERT INTO ErrorDef (ErrorCode,Description,Priority,Explanation) VALUES (304,'‘SENSupportFlag’ does not contain a recognised value',2,'Recognised values are ''Y'' and ''N''');;
INSERT INTO ErrorDef (ErrorCode,Description,Priority,Explanation) VALUES (305,'‘DateVerified’ is greater than ‘Period End Date’',2,'Activity verification date should never be greater than the period end date in the XML file uploaded for that specific month');;
